...
public:
    ...
    int getFirst() { // Повернути перше число
        return first;
    }
    int getSecond() { // Повернути друге число
        return second;
    }
    void setFirst(int a) { // Встановити перше число
        first = a;
    }
    void setSecond(int b) { // Встановити друге число
        second = b;
    }
...
public:
    // Конструктори класу
    COMPLEX() : PAIR() { // Конструктор без параметрів
        real = 0;
        imag = 0;
    }
    COMPLEX(int a, int b) : PAIR(a, b) { // Конструктор з параметрами
        real = a;
        imag = b;
    }
    // Деструктор класу
    ...
    // Селектори та модифікатори
    int getReal() { // Повернути дійсну частину числа
        return real;
    }
    int getImag() { // Повернути уявну частину числа
        return imag;
    }
    void setReal(int a) { // Встановити дійсну частину числа
        real = a;
    }
    void setImag(int b) { // Встановити уявну частину числа
        imag = b;
    }
    // Перевантажена операція присвоєння
